...
export default function AnimatedButton({
    ...
    return (
        <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className={cn(
                'relative inline-flex items-center justify-center px-4 py-2.5 md:py-2 text-sm font-medium rounded-xl transition-all duration-200 border min-h-[44px] md:min-h-[40px]',
